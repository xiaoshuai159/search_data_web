<template>
  <div class="all">
      <header>
        <span style="margin:10px 8px 8px 117.5px">IP :</span><span><el-input v-model="searchValue.ip"></el-input></span>
          <span style="margin:10px 8px 8px 106px">境内外 :</span><span>
            ...
            <span style="margin:10px 8px 8px 89px">备案归属 :</span><span><el-input v-model="searchValue.owner"></el-input></span>
          <span style="margin:2px 8px 8px 68px">起始时间 :</span><span><el-date-picker
            v-model="start_time"
            type="datetime"
            placeholder="选择时间"
            align="right"
          ...
          <span style="margin:2px 8px 8px 73px">数据库类型 :</span>
            <span>
          ...
          <span style="margin:2px 8px 8px 100px">省份 :</span><span><el-input v-model="searchValue.province"></el-input></span>
          <span style="margin:2px 8px 8px 122px">地市 :</span><span><el-input v-model="searchValue.city"></el-input></span>
          <span style="margin:2px 8px 8px 121px">区县 :</span><span><el-input v-model="searchValue.district"></el-input></span>
          
          
          <span style="margin:-6px 8px 8px 130px"><el-button @click="search()">查询</el-button></span>
